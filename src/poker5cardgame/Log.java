...
public class Log {
    ...
    public enum Format {
        ...
        {
            return new Format[]{RED, ORANGE, YELLOW, GREEN, BLUE, CYAN, PURPLE, PINK, 
                PURPLE, CYAN, BLUE, GREEN, YELLOW, ORANGE};
        }
    }
    ...
    public static final String SKULL = "                             ,..oooooooooob..                         \n" +
"                       ,.dodOOOO\"\"\"\"\"\":\"ooPO88bo..                    \n" +
"                     .o8O\"\"\" '            \"'\"\"\"PO8b.                  \n" +
"                 .dd8P'\"                       ''::Y8o.               \n" +
"               ,d8Po'                             \"':7Ob;             \n" +
